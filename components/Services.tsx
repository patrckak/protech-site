    ...
    <section className="min-w-screen min-h-screen p-10 flex flex-col gap-16">
      ...
      <section className="max-w-5xl mx-auto px-6 space-y-6">
        ...
        <p className="leading-relaxed font-light text-justify">
          Com <strong>+6 anos</strong> e <strong>+500</strong> clientes satisfeitos, atuamos com foco total em
          qualidade, segurança e confiabilidade, utilizando boas práticas
          técnicas, profissionais qualificados para garantir resultados
        ...
        <span className="flex flex-row items-center justify-center">
          <Button className=" mt-6 bg-[#00B874] hover:bg-[#009e5a] hover:shadow-md">
